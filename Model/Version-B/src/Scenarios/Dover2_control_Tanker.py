def initial(simulation):
    ...
    simulation.world.do["Astrorunner"].waypoints.append([1700, 300])
    simulation.world.do["Astrorunner"].waypoints.append([800, -350])
    simulation.world.do["Astrorunner"].waypoints.append([-2500, 2000])
