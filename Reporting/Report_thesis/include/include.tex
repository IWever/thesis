...
%% Checkmark and cross for tables
...
\begin{titlepage}
	...
	\large
	\vspace{1cm}	
	by Ingmar Wever at Damen Shipyards, \\	
	to be defended publicly on Wednesday 19 December 2018 at 11:00.
	
	\vspace{1.5cm}
	\footnotesize
	This thesis (SDPO.18.048.m) is classified as confidential in accordance with the general conditions for projects at the TU Delft. An electronic version of this thesis is available via \\ \url{http://repository.tudelft.nl/}.
	
	\vspace{3cm}
	\normalsize
	\begin{tabular}{lll}
		Student: & Ingmar Wever (4161041) & \\
		Project duration: & \multicolumn{2}{l}{September 2017 -- December 2018} \\
		& & \\
		Daily supervisor: & ing. Toine Cleophas & Damen Shipyards, R\&D \\
		Committee members: & Dr.ir. Robert Hekkenberg & TU Delft, Ship Design \\
		& Prof.Dr. Mark Neerincx & TU Delft, Interactive Intelligence \\
		& Dr.ir. Peter de Vos & TU Delft, Marine Engineering \\
...
\newcommand{\lastPage}{
	...
	\vfill
	\centering
	\includegraphics[height=1.95cm, keepaspectratio]{TU_Delft_logo_RGB.png}
	\hspace{.8cm}
	\includegraphics[height=1.2cm, keepaspectratio]{Damen_logo.png}
