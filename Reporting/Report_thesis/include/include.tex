...
\usepackage[bordercolor=orange,backgroundcolor=blue!10,linecolor=black,textsize=footnotesize]{todonotes} % placing todo notes and summarizing them at start of document
\usepackage{wrapfig}
...
\newcommand{\addCoverPage}{
	...
	\begin{tikzpicture}[remember picture,overlay]
		...
		\node (title-box) at (current page.east) [minimum width=.5\paperwidth, minimum height=7cm, align=left, xshift=-.3\paperwidth, yshift=-5cm, text=white] {
			...
			\Large{requirements for safe operation of} \\
			\Large{autonomous and unmanned vessels} \\ \\
			Ingmar Wever \\
			\today
