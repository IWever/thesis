...
\newcommand{\addEmptyPage}{
	...
	\end{center}
	\todo{Titels begeleiders, thesis number and graduation date}
}
...
\newcommand{\addTitlePage}{
	...
	\vspace{1.5cm}
	\footnotesize
	This thesis (THESISNUMBER) is classified as confidential in accordancewith the general conditions for projects performed by the TU Delft. 
