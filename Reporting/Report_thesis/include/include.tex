...
\newcommand{\addTitlePage}{
	...
	\Large
	\vspace*{.8cm}
	Thesis Report for the degrees of \\ 
	MSc Marine Technology specialising in ship design and \\
	MSc Computer Science specialising in interactive intelligence \\
	\vspace{1cm}
	\begin{spacing}{2}
		\begin{Huge}
	...
	\vspace{1.5cm}
	\footnotesize
	This thesis (SDPO.18.048.m) is classified as confidential in accordance with the general conditions for projects performed at the TU Delft. 
	...
	\begin{tabular}{lll}
		...
		Committee members: & Dr.ir. Peter de Vos & TU Delft, Marine Engineering \\
