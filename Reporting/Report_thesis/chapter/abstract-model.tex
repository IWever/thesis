...
As mentioned before, first must be known how ship characteristics and gathered information influence the possible decisions and ability to estimate intentions. This is made understandable using an abstract model. Here is also a separation made between the relevance of the subjects for Maritime Technology and Computer Science. 
...
\end{figure}
\todo{Make model in same style as infographic and situation sketches, using blocks as mentioned below}
