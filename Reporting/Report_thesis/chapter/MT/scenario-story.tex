...
\todo{Evaluate scenarios using decision process as described in previous chapter}
\todo{niet zeker dat dit nuttig is}
...
\todo{describe how ships can be tweaked to function better}
