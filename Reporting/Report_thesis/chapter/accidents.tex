...
\end{itemize}
\todo{Are these really relevant accidents, add more/other?}
...
\begin{wrapfigure}{L}{0.6\textwidth}
	\centering
	\includegraphics[width=.6\textwidth]{Conti-Peridot-Carla-Maersk-crash.png}
	\caption{Illutstration map of approximate collision location}
...
\todo{Summaries all lessons learned from the above mentioned accidents}
