...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \emph{Helmsman and lookout}. Both monitor the situation and execute commands from the officer of watch. A risk for them is information overload, which could result in information overload. \todo{citation or reference}
	\end{itemize}
...
Human factors knowledge describes available knowledge coming from previous research about how to solve the problems that have been identified in the problem analysis. \todo{focus op situation awareness en taakbelasting, dialoog aspecten}
\begin{itemize}
	...
	\item ...
\end{itemize}
\todo{link papers to questions and answer, keep short}
